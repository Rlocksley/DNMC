...
class DNMC:
	def __init__(self,batch_size,extern_input_size,extern_output_size,memory_address_size,memory_input_size,NM_size,num_read_heads,hidden_size,memory_memory_address_size,memory_memory_input_size,memory_NM_size,):
		...
		self.controller_input_size=self.extern_input_size+self.memory_input_size*self.num_read_heads+self.memory_controller_input_size*self.NM_size+2*self.NM_size*self.NM_size+self.NM_size*self.memory_controller_output_size+self.memory_memory_controller_output_size+self.memory_memory_controller_input_size*self.memory_NM_size+2*self.memory_NM_size*self.memory_NM_size+self.memory_NM_size*self.memory_memory_controller_output_size
	...
	def Controller(self,extern_input,memory_input,memory_layer1,memory_layer2,memory_layer3,memory_layer4,memory_memory_input,memory_memory_layer1,memory_memory_layer2,memory_memory_layer3,memory_memory_layer4):
		...
		controller_input=tf.concat([extern_input,memory_input,memory_layer1,memory_layer2,memory_layer3,memory_layer4,memory_memory_input,memory_memory_layer1,memory_memory_layer2,memory_memory_layer3,memory_memory_layer4],axis=1)
	...
	def Memory_Change2(self,erase_weight1,erase_weight2,erase_weight3,erase_weight4,memory_layer1,memory_layer2,memory_layer3,memory_layer4):
                ...
                memory_layer1=tf.tanh(tf.subtract(memory_layer1,erase_weight1))
                memory_layer2=tf.tanh(tf.subtract(memory_layer2,erase_weight2))
                memory_layer3=tf.tanh(tf.subtract(memory_layer3,erase_weight3))
                memory_layer4=tf.tanh(tf.subtract(memory_layer4,erase_weight4))
	...
	def train(self,train_steps,path_to_tb_dir):
                ...
                for i in xrange(train_steps):
                        ...
                        for j in xrange(self.batch_size):
                                ...
                                batch_y=np.append(batch_y,np.append(np.zeros((5,self.extern_output_size)),np.flip(random_vector,axis=0),axis=0).reshape(1,time_steps,self.extern_output_size),axis=0)
...
DNMC=DNMC(batch_size=200,extern_input_size=1,extern_output_size=1,memory_address_size=6,memory_input_size=8,NM_size=10,num_read_heads=6,hidden_size=100,memory_memory_address_size=2,memory_memory_input_size=2,memory_NM_size=4)
